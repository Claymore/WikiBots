...
namespace Claymore.NewPagesWikiBot
{
    internal class Program
    {
        static int Main(string[] args)
        {
            ...
            List<Portal> portals = new List<Portal>
            {
                ...
                new Portal("Армения", new IPortalModule[] { new NewPagesWithArchive(new string[] {"Армения"},
                                                                                    ...
                                                                                    "Портал:Армения/Новые статьи",
                                                                                    "Портал:Армения/Новые статьи/Архив",
                                                                                    "Армения",
                                                                                    25,
                                                                                    "* [[{0}]] — [[User:{1}|{1}]] {2}",
                                                                                    "d MMMM yyyy") }),
                new Portal("Белоруссия", new IPortalModule[] { new NewPages("Белоруссия", "Портал:Белоруссия/Новые статьи", 15, "* [[{0}]]") }),
                new Portal("БиологияА", new IPortalModule[] { new NewPages("Биология", "Портал:Биология/Новые статьи", 30, "* [[{0}]]") }),
                new Portal("БиологияБ", new IPortalModule[] { new NewPagesWithAuthors("Биология", "Википедия:Проект:Биология/Новые статьи", 60, "{{{{Новая статья|{0}|{2}|{1}}}}}", "d MMMM yyyy") }),
                ...
                new Portal("История", new IPortalModule[] { new NewPages("История", "Портал:История/Новые статьи", 25, "* [[{0}]]") }),
                ...
                new Portal("Перу", new IPortalModule[] { new NewPages("Перу", "Портал:Перу/Новые статьи", 20, "# [[{0}]]") }),
                new Portal("Шотландия", new IPortalModule[] { new NewPages("Шотландия", "Портал:Шотландия/Новые статьи") }),
                new Portal("Уэльс", new IPortalModule[] { new NewPages("Уэльс", "Портал:Уэльс/Новые статьи") }),
                new Portal("Религия", new IPortalModule[] { new NewPages("Эротика", "Портал:Эротика и порнография/Новые статьи") }),
                new Portal("Эротика", new IPortalModule[] { new NewPages("Греция", "Портал:Греция/Новые статьи") }),
                new Portal("Награды", new IPortalModule[] { new NewPages("Награды", "Портал:Награды/Новые статьи") }),
                new Portal("Лютеранство", new IPortalModule[] { new NewPages("Лютеранство", "Портал:Лютеранство/Новые статьи", 15, "* [[{0}]]") }),
                new Portal("Мексика", new IPortalModule[] { new NewPages("Мексика", "Портал:Мексика/Новые статьи") }),
                new Portal("Средние века", new IPortalModule[] { new NewPages("Средние века", "Портал:Средневековье/Новые статьи") }),
                new Portal("Одесса", new IPortalModule[] { new NewPages("Одесса", "Портал:Одесса/Новые статьи") }),
                new Portal("Психоактивные вещества", new IPortalModule[] { new NewPages("Психоактивные вещества", "Портал:Психоактивные субстанции/Новые статьи") }),
                new Portal("Шотландия", new IPortalModule[] { new NewPages("Шотландия", "Портал:Шотландия/Новые статьи") }),
                new Portal("Южная Америка", new IPortalModule[] { new NewPages("Южная Америка", "Портал:Южная Америка/Новые статьи") }),
                new Portal("Испания", new IPortalModule[] { new NewPages("Испания", "Портал:Испания/Новые статьи") }),
                new Portal("Турция", new IPortalModule[] { new NewPages("Турция", "Портал:Турция/Новые статьи") }),
                new Portal("Великобритания", new IPortalModule[] { new NewPages("Великобритания", "Портал:Великобритания/Новые статьи") }),
                new Portal("США", new IPortalModule[] { new NewPages("США", "Портал:США/Новые статьи") }),
                new Portal("Эстония", new IPortalModule[] { new NewPages("Эстония", "Портал:Эстония/Новые статьи") }),
                new Portal("Генетика", new IPortalModule[] { new NewPages("Генетика", "Портал:Генетика/Новые статьи") }),
                new Portal("Франция", new IPortalModule[] { new NewPages("Франция", "Портал:Франция/Новые статьи") }),
                new Portal("Каталония", new IPortalModule[] { new NewPages("Каталония", "Портал:Каталония/Новые статьи") }),
                new Portal("Камбоджа", new IPortalModule[] { new NewPages("Камбоджа", "Портал:Камбоджа/Новые статьи") }),
                new Portal("Таиланд", new IPortalModule[] { new NewPages("Таиланд", "Портал:Таиланд/Новые статьи") }),
                new Portal("Татарстан", new IPortalModule[] { new NewPages("Татарстан", "Портал:Татарстан/Новые статьи") }),
                new Portal("Православие", new IPortalModule[] { new NewPages("Православие", "Портал:Православие/Новые статьи", 25, "# [[{0}]]", false) }),
                new Portal("Тула", new IPortalModule[] { new NewPages("Тула", "Портал:Тула/Новые статьи", 20, "# [[{0}]]") }),
                ...
                new Portal("Древний Восток", new IPortalModule[] { new NewPagesWithAuthors("Древний Восток", "Портал:Древний Восток/Новые статьи", 25, "* [[{0}]] — [[User:{1}|{1}]] {2}", "d MMMM yyyy") }),
                new Portal("Индейцы", new IPortalModule[] { new NewPagesWithAuthors("Индейцы", "Портал:Индейцы/Новые статьи", 20, "* [[{0}]] <small>— [[User:{1}|{1}]] {2}</small>", "d MMMM yyyy") }),
                new Portal("Доисторическая Европа", new IPortalModule[] { new NewPagesWithAuthors("Доисторическая Европа", "Портал:Доисторическая Европа/Новые статьи", 25, "* [[{0}]] — [[User:{1}|{1}]] {2}", "d MMMM yyyy") }),
                new Portal("Лингвистика", new IPortalModule[] { new NewPagesWithAuthors("Лингвистика", "Портал:Лингвистика/Новые статьи", 30, "# [[{0}]] — [[User:{1}|{1}]] {2}", "d MMMM yyyy") }),
                new Portal("Ирландия", new IPortalModule[] { new NewPagesWithAuthors("Ирландия", "Портал:Ирландия/Новые статьи", 20, "* '''{2}''' — [[{0}]]", "[[d MMMM]] [[yyyy]]") }),
                new Portal("Монголия", new IPortalModule[] { new NewPagesWithArchive("Монголия", "Портал:Монголия/Новые статьи", "Портал:Монголия/Новости/Архив", 20, "{{{{Новая статья|{0}|{2}|{1}}}}}", "d MMMM yyyy") }),
                ...
                new Portal("Германия", new IPortalModule[] { new NewPagesWithAuthors("Германия", "Портал:Германия/Новые статьи", 20, "* [[{0}]] <small>— {2}</small>", "d MMMM yyyy") }),
                new Portal("Этнология", new IPortalModule[] { new NewPagesWithAuthors("Этнология", "Портал:Этнология/Новые статьи", 20, "* [[{0}]] — [[User:{1}|{1}]] {2}", "d MMMM yyyy") }),
                new Portal("Канада", new IPortalModule[] { new NewPagesWithAuthors("Канада", "Портал:Канада/Новые статьи", 15, "# [[{0}]] <small>— {2} [[User:{1}|{1}]]</small>", "dd.MM.yy") }),
                new Portal("Сельское хозяйство", new IPortalModule[] { new NewPagesWithAuthors("Сельское хозяйство", "Портал:Сельское хозяйство/Новые статьи", 20, "{{{{Новая статья|{0}|{2}|{1}}}}}", "d MMMM yyyy") }),
                ...
                new Portal("Финляндия", new IPortalModule[] { new NewPagesWithAuthors("Финляндия", "Портал:Финляндия/Новые статьи", 35, "{{{{Новая статья|{0}|{2}|{1}}}}}", "d MMMM yyyy") }),
                new Portal("Швеция", new IPortalModule[] { new NewPagesWithAuthors("Швеция", "Портал:Швеция/Новые статьи", 20, "{{{{Новая статья|{0}|{2}|{1}}}}}", "d MMMM yyyy") }),
                new Portal("Ужасы", new IPortalModule[] { new NewPagesWithAuthors("Ужасы", "Портал:Хоррор/Новые статьи", 20, "# [[{0}]] — {2}", "d MMMM") }),
                new Portal("Телевидение", new IPortalModule[] { new NewPagesWithAuthors("Телевидение", "Портал:Телевидение/Новые статьи", 20, "* [[{0}]] — {2}", "d MMMM") }),
                new Portal("Крым", new IPortalModule[] { new NewPagesWithAuthors("Крым", "Портал:Крым/Новые статьи", 20, "* [[{0}]] — {2}", "d MMMM") }),

                new Portal("Энтомология", new IPortalModule[] { new NewPagesWithImages("Энтомология", "Портал:Энтомология/Новые статьи", 9, "Файл:{1}|[[{0}]]",
                    "<gallery perrow=\"3\" widths=\"110px\">",
                    "</gallery>\nОсновной список новых статей в [[Википедия:Проект:Энтомология]].") }),
                new Portal("Микология", new IPortalModule[] { new NewPagesWithImages("Микология", "Портал:Микология/Новые статьи", 8, "Файл:{1}|[[{0}]]",
                    "<div align=\"center\"><gallery perrow=\"1\" widths=\"80px\">",
                    "</gallery></div>") }),
                new Portal("Ботаника", new IPortalModule[] { new NewPagesWithImages("Ботаника", "Портал:Ботаника/Новые статьи", 8, "Файл:{1}|[[{0}]]",
            ...
            portals.Sort(ComparePortalsByName);
        ...
        private static int ComparePortalsByName(Portal x, Portal y)
        {
